...
const Footer = forwardRef((props) => {
  ...
  const handleCopyEmail = () => {
    navigator.clipboard.writeText("matilda@krimarc.se").then(() => {
      setCopied(true);
        ...
        <div className="links">
          <Button onClick={handleCopyEmail}>
            ...
            <p className="email-text">
              {copied ? "Copied!" : "matilda@krimarc.se"}
            </p>
          </Button>
          <div className="socials">
            <a
              className="a1"
              href="https://www.linkedin.com/in/matilda-danielsson-aa58b72a3"
              target="_blank"
            ...
            <a
              className="a2"
              href="https://github.com/matiiilda"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              className="a3"
              href="https://www.figma.com/design/wTyWO4Hm2RLVEGebgK8N3k/Untitled?node-id=0-1&t=lJk3V6mQhtQTyDCp-1"
              target="_blank"
              rel="noopener noreferrer"
            >
      ...
      <div className="copyright">
        {isMobile ? (
          <p>
            ...
            Designed & built by Matilda; Powered by coffee
          </p>
        ) : (
          <p>
            &copy; {new Date().getFullYear()} All rights reserved. Designed &
            built by Matilda; Powered by coffee
          </p>
        )}
      </div>
    </Element>
